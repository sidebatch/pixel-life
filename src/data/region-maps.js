...
const REGION_WORLDS=Object.freeze({
  ...
  oldForest:Object.freeze({
    ...
    trees:[
      {x:15,y:16},{x:19,y:12},{x:23,y:15},{x:29,y:12},{x:33,y:16},
      {x:15,y:21},{x:20,y:19},{x:29,y:22},{x:34,y:25},{x:17,y:32},
      {x:36,y:32},{x:16,y:39},{x:30,y:40},{x:33,y:42},{x:50,y:17},
      {x:53,y:23},{x:51,y:31},{x:55,y:37},
      {id:'forest_tree_01',x:23,y:39,interactable:true},
      {id:'forest_tree_02',x:28,y:38,interactable:true},
      {id:'forest_tree_03',x:22,y:33,interactable:true},
      {id:'forest_tree_04',x:28,y:30,interactable:true},
      {id:'forest_tree_05',x:20,y:26,interactable:true},
      {id:'forest_tree_06',x:34,y:22,interactable:true},
      {id:'forest_tree_07',x:33,y:18,interactable:true},
      {id:'forest_tree_08',x:21,y:17,interactable:true}
    ],
