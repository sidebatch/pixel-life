...
- 오래된 숲 1-1에는 참나무·소나무·자작나무, 안쪽 1-2에는 나머지 5종을 밀도 있게 배치. 기본 도끼로 1-1, 철 도끼로 1-2 중급, 강철 도끼로 1-2 상급 나무를 벌목. 완전 벌목 시 해당 통나무 1~3개, 현실 시간 5분 후 재생
...
- 벌목 3단계의 비용·종별 XP·판매가·모션을 모바일 플레이 테스트로 조정하고, 필요하면 전용 4방향 × 2장 스프라이트로 고도화
