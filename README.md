...
세로형 모바일 화면을 기준으로 제작 중인 탑다운 픽셀 생활 어드벤처입니다. 라일락 연못 마을에서 오래된 숲·햇살 농장으로 이동할 수 있으며, 세 지역의 낚시와 벌목·농사·상점 거래를 즐길 수 있습니다. 월드 시간·날씨, 물고기 20종, 도감·저장·누적 보상, 낚시 성장과 장비도 연결되어 있습니다.
...
src/
  ...
  data/region-maps.js 숲·농장 지역과 지역 간 출입구
  ...
  market.js          물고기·통나무·작물 판매와 씨앗 구매
  fish-dex.js        도감 필터, 통계, 힌트, 보상 진행도
  fishing-gear.js    낚싯대 선택·장착 UI
  main.js            게임 루프
...
- 각각 64×48 타일인 마을·숲·농장 지역과 카메라, 북쪽·동쪽 출입구
- 플레이어 이동 및 충돌
- NPC 6명의 로밍과 대화
...
- 낚시 Lv.1·5·10·15와 도감 20종 보상으로 사용 가능한 낚싯대 5종
- 낚싯대 선택 UI, 장착 저장과 입질 시간·희귀 이상 Weight·큰 개체 보정
- 가방의 물고기·장비 탭: 3열 물고기 이미지 카드, 이미지 우측 상단 보유 수, 커서·터치로 이름 확인 (개별 크기·판매가 기록은 저장 유지)
- 마을 남쪽 길가의 엘리 상점 건물: 엘리 앞에서 `상점`을 눌러 물고기·재료를 판매하거나 씨앗을 구매. 건물 전체에 충돌 판정을 적용하고, 판매 성공 시 제공받은 돈 소리와 코인 증가 연출
- 오래된 숲의 모든 나무 벌목 가능(이미지 8종): 3회 타격, 통나무 2~4개, 현실 시간 5분 후 재생
- 숲의 나무 8종·그루터기 8종 픽셀 아트와 가방·상점의 통나무 이미지
- 햇살 농장의 4×4 고정 밭: 초기 4칸, 단계별 영구 확장, 씨앗 심기·오프라인 성장·수확
- 엘리 상점에서 작물 10종의 씨앗 구매, 물고기·통나무·수확 작물의 수량별 판매
...
- 확정 성장 설계를 바탕으로 벌목 XP·레벨·피드백 연결
