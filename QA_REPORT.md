...
대상: 기존 공개 빌드와 이번 생활 스킬 성장·UI 개편 로컬 빌드
...
이번 변경의 390×844 로컬 모바일 QA에서는 도감 카드→중앙 정보 팝업→뒤로가기 복귀, 장비 화면의 XP 바와 한국어 사용 조건, 실제 낚시 결과의 +XP→72/72 XP(100%)→Lv.2·8/84 XP 전환을 확인했다. 수정된 공개 Pages 빌드는 배포 후 별도로 확인한다.
