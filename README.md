...
세로형 모바일 화면을 기준으로 제작 중인 탑다운 픽셀 생활 어드벤처입니다. 현재 빌드는 라일락 연못 마을의 이동·NPC·월드 렌더링 기반 위에 월드 시간, 비·폭풍 날씨, 물고기 20종, 도감·저장·누적 보상과 낚싯대 장비가 연결된 낚시 수직 슬라이스를 구현했습니다.
...
- Fishing Lv.1·5·10·15와 도감 20종 보상으로 해금되는 낚싯대 5종
